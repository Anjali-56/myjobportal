<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageJobseeker.aspx.cs" Inherits="myjobprotal.AdminModule.ManageJobseeker" %>
                ...
                <asp:GridView ID="gvjobseekers" runat="server" AutoGenerateColumns="False"
                    ...
                    <columns>
                        ...
                        <asp:TemplateField HeaderText="Job Profile">
                            <ItemTemplate>
                                <%#Eval("jpname") %> (<%#Eval("jsexperience") %> Years)
                            </ItemTemplate>
                        </asp:TemplateField>
